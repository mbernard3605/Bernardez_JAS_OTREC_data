...
%     [tp(:,i),hp(:,i)]=zero_plume_buoyancy_split(tempShape(:,i),mrShape(:,i),z(1:78)*1000,presShape(:,i));
% end
% 
% dt=tp-tempShape;

save('OTREC_B2_zbp_start_ent.mat','xShape','yShape','tempShape','mrShape','presShape','z');